...
import 'package:testes/ui/pages/survey_result/components/components.dart';
...
void main() {
  ...
  SurveyResultViewModel makeSurveyResult() =>
      SurveyResultViewModel(surveyId: '0', question: 'Question', answers: [
  ...
  testWidgets('Should handle correctly', (WidgetTester tester) async {
    await loadPage(tester);
  ...
  testWidgets('Should present error if surveyStream fails',
      (WidgetTester tester) async {
    await loadPage(tester);
  ...
  testWidgets('Should call loadResult on reload click',
      (WidgetTester tester) async {
    await loadPage(tester);
  ...
  testWidgets('Should present valid data ig surveyresult succeed',
      (WidgetTester tester) async {
    await loadPage(tester);
