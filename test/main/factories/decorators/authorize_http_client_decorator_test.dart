...
import 'package:testes/main/decorators/decorators.dart';
...
void main() {
  ...
  test('Should throw forbidden if fetchsecure throws', () async {
    mockTokenError();
    final future = sut.request(url: url, method: method, body: body);
    expect(future, throwsA(HttpError.forbidden));
  });

  test('Should rethrow forbidden if fetchsecure throws', () async {
